...
// Time integrals
inline double norm_expcosh(const double &t, const double &tau,
                           const double &DGon2) {
...
inline double norm_expcosh(const double &t_min, const double &t_max,
                           const double &tau, const double &DeltaGamma) {
  return norm_expcosh(t_max, tau, DeltaGamma / 2.0) -
         norm_expcosh(t_min, tau, DeltaGamma / 2.0);
}

inline double norm_expsinh(const double &t, const double &tau,
                           const double &DGon2) {
  return (tau *
...
inline double norm_expsinh(const double &t_min, const double &t_max,
                           const double &tau, const double &DeltaGamma) {
