 ...
 * LASS
 */
inline std::complex<double> lass(const double &m, const double &m0,
                                 const double &Gamma0, const double &q,
                                 const double q0, const double &a,
                                 const double &r) {
  ...
  return sin(deltaF) * std::polar(1.0, deltaF) +
         sin(deltaR) * std::polar(1.0, deltaR + 2.0 * deltaF);
}
